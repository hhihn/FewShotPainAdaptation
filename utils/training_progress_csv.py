...
class TrainingProgressCSVWriter:
    ...
    def write_event(
        ...
        can_global_loss: Optional[float] = None,
        ...
        transductive_loss: Optional[float] = None,
        transductive_accuracy: Optional[float] = None,
        transductive_precision: Optional[float] = None,
        transductive_recall: Optional[float] = None,
        transductive_f1: Optional[float] = None,
        transductive_intra_class_similarity: Optional[float] = None,
        transductive_inter_class_similarity: Optional[float] = None,
        transductive_similarity_margin: Optional[float] = None,
        transductive_selected_count: Optional[int] = None,
        ...
        self._writer.writerow(
            {
                ...
                "transductive_loss": transductive_loss,
                "transductive_accuracy": transductive_accuracy,
                "transductive_precision": transductive_precision,
                "transductive_recall": transductive_recall,
                "transductive_f1": transductive_f1,
                "transductive_intra_class_similarity": transductive_intra_class_similarity,
                "transductive_inter_class_similarity": transductive_inter_class_similarity,
                "transductive_similarity_margin": transductive_similarity_margin,
                "transductive_selected_count": transductive_selected_count,
